...
<div class="content">
    <div id="settings">
        <div class="tabs">
            ...
            <button class="tablinks" onclick="openTab(event, 'currencies')">Currencies</button>
        ...
        <div id="profile" class="tabcontent">
            ...
            <p>This is the profile settings content.</p>
        </div>
        ...
        <div id="categories" class="tabcontent">
            ...
            <p>This is the categories settings content.</p>
        </div>
        
        <div id="currencies" class="tabcontent">
            <h1>Currencies Settings</h1>
            <p>This is the currencies settings content.</p>
        </div>
        
        <div id="support" class="tabcontent">
            <h1>Support Settings</h1>
            <p>This is the support settings content.</p>
        </div>
        </div>
